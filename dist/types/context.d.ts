 ...
 */
export type AmalaContext<StateT extends object = EmptyContext, ContextT extends object = EmptyContext, ResponseBodyT = unknown> = KoaApplication.ParameterizedContext<StateT, ContextT, ResponseBodyT>;
...
export type AmalaMiddleware<StateT extends object = EmptyContext, ContextT extends object = EmptyContext> = (ctx: AmalaContext<StateT, ContextT>, next: AmalaNext) => unknown | Promise<unknown>;
