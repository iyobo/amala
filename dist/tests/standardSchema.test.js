...
const StandardSchemaController_1 = require("./util/controllers/StandardSchemaController");
let nativeServer;
let testServer;
beforeAll(async () => {
    const { app } = await (0, index_1.bootstrapControllers)({
        controllers: [StandardSchemaController_1.StandardSchemaController],
...
//# sourceMappingURL=standardSchema.test.js.map